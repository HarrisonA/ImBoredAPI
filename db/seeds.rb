...
bar4 = Bar.create(name: "Hawthorne", url: "www.BarOne.com", description: "Blah blah", why: "I love this Bar", numofvisits:0, photo:"no photo yet", notes: "none", hide:false, city: cit2)
bar5 = Bar.create(name: "Temple", url: "www.BarTwo.com", description: "Blah blah", why: "this Bar is fun", numofvisits:0, photo:"no photo yet", notes: "none", hide:false, city: cit2)
bar6 = Bar.create(name: "Jillian's", url: "www.BarThree.com", description: "Blah blah", why: "This Bar is quiet", numofvisits:0, photo:"no photo yet", notes: "none", hide:false, city: cit2)
bar7 = Bar.create(name: "Garage", url: "www.BarOne.com", description: "Blah blah", why: "I love this Bar", numofvisits:0, photo:"no photo yet", notes: "none", hide:false, city: cit3)
bar8 = Bar.create(name: "Trinity", url: "www.BarTwo.com", description: "Blah blah", why: "this Bar is fun", numofvisits:0, photo:"no photo yet", notes: "none", hide:false, city: cit3)
bar9 = Bar.create(name: "Tia Lou's", url: "www.BarThree.com", description: "Blah blah", why: "This Bar is quiet", numofvisits:0, photo:"no photo yet", notes: "none", hide:false, city: cit3)
...
movie3 = Movie.create(name: "MovieThree", url: "www.moviethree.com", description: "Blah blah", why: "This movie is quiet", numofvisits:0, photo:"no photo yet", notes: "none", hide:false, city: cit3)
